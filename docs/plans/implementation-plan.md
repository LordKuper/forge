...
- [ ] P8.34–P8.41 — Isolate release, Debug, and tests by instance id; test same-user enforcement, hostile clients, crashes, abandoned leases, stale clients, recovery, and three-OS behavior. **Reopened 2026-08-15 audit:** same-user enforcement (`CurrentUserOnly`) has no automated test with a second OS user.
