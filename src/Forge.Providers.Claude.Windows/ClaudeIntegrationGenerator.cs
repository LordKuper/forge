...
public sealed class ClaudeIntegrationGenerator : IProviderIntegrationGenerator
{
    ...
    public GeneratedArtifact Generate(CanonicalIntegrationSource source)
    {
        ...
        // requirement even though this thin import file is never itself digested.
        string content = $"{IntegrationSourceCompiler.Marker(source.SourceDigest, source.GeneratorVersion)}\n\n" +
            "@AGENTS.md\n";
        return new(
            ProviderId,
            "CLAUDE.md",
